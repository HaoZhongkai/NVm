...
nVar=80;                % Number of Unknown (Decision) Variables

VarSize=[1 nVar];       % Decision Variables Matrix Size

VarMin=-100e-3;             % Lower Bound of Decision Variables
VarMax= 100e-3;             % Upper Bound of Decision Variables
...
function loss = CostFunction(Position,S0)
    ...
    Px = Get_Px2(S0.t,A,B,S0.wl,S0.N);
    delta = Px-S0.Px;
    loss = sum(abs(delta));
end
